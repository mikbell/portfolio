<template>
	<section
		...
		<div
			...
			<!-- Immagine Profilo -->
			<div
				class="w-64 h-64 md:w-96 md:h-96 relative"
				data-aos="zoom-in"
				data-aos-delay="300"
				data-aos-duration="1200">
				<div
					class="absolute inset-0 bg-gradient-to-br from-gray-900 to-gray-600 rounded-full transform -rotate-6"></div>
				<img
					:src="profileImage"
					alt="Profile"
			...
			<div
				...
				data-aos-duration="1000">
				<h1
					class="text-5xl md:text-7xl font-bold bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent">
					Michele Campanello
				</h1>
				...
				<div
					...
					data-aos-delay="600"
					data-aos-duration="1000">
					<SecondaryButton as="a" href="/CV.pdf" download>
						Scarica il CV
					</SecondaryButton>

					<PrimaryButton as="a" href="#contatti"> Contattami </PrimaryButton>
				</div>
				<div
					class="flex gap-6 justify-center md:justify-start pt-4"
					data-aos="fade-up"
					data-aos-delay="700"
					data-aos-duration="1000">
					<a
...
<script setup>
	...
	// Props
	defineProps(["socialLinks", "profileImage"]);
</script>
